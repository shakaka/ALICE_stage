AliDoubleJpsi *AddDoubleJpsi(Bool_t usePhysicsSelection, TString outputFileName = "") {
 ...
 //Create and configure task
  AliDoubleJpsi *task = new AliDoubleJpsi("AliDoubleJpsi");
  if (!task) {
    Error("AliDoubleJpsi","AliDoubleJpsi task cannot be created! ");
    return NULL;
  }
