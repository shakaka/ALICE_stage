AliAnalysisJpsi *AddTaskJpsi(Bool_t usePhysicsSelection, TString outputFileName = "") {
 ...
 //Create and configure task
  AliAnalysisJpsi *task = new AliAnalysisJpsi("AliAnalysisJpsi");
  if (!task) {
    Error("AliAnalysisJpsi","AliAnalysisJpsi task cannot be created! ");
    return NULL;
  }
